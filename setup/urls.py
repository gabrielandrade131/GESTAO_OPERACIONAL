...
urlpatterns = [
    ...
    path('api/mobile/v1/app-update/', views_mobile_api.mobile_app_update, name='api_mobile_app_update_alias_kebab'),
    path('api/mobile/v1/app/check-update/', views_mobile_api.mobile_app_update, name='api_mobile_app_update_alias_check'),
